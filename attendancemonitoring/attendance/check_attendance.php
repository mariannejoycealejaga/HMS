                      ...
                      <div class="col-sm-5 wow fadeInDown">
                              ...
                              <div class="panel" id="imgview">            
                                ...
                                <!-- <a href="" data-target="#employeemodal" data-toggle="modal" > -->
                                    <img title="profile image" id="imgprofile" class="img-hover"    src="<?php //echo web_root. 'admin/employee/'.  $res->EmPhoto; ?>">
                                <!-- </a> -->
                                 </div>
                      ...
                      <div class="col-sm-7 wow fadeInDown"> 
                        ...
                        <div class="col-md-8"> 
                          	  ...
                          	  <ul class="list-group">
                                  ...
                                  <li class="list-group-item text-right"><span class="pull-left">IDNO</span><input class="EmployeeID" type="text" id="EmployeeID"></li>
                                  <li class="list-group-item text-right"><span class="pull-left">Name</span><label id="name">NONE</label> </li>
                                  <li class="list-group-item text-right"><span class="pull-left">POSITION</span><label id="position">NONE</label></li>
                                  <!-- <li class="list-group-item text-right"><span class="pull-left">EMPLOYEE STATUS</span><label id="level">NONE</label> </li> -->
...
<h2>
 ...
 <center>
   <footer>        
    <p  style="color:#fff;font-size: 24px">RFID Attendance Monitoring System  </p>  
    </footer>
</center>
...
<script type="text/javascript" language="javascript" src="<?php echo web_root; ?>js/attendance_employee.js"></script>  
