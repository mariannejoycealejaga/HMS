                        ...
                        <form class="form-horizontal span6  wow fadeInDown" action="controller.php?action=add" method="POST"> 
                              ...
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                   ...
                                   <input class="form-control input-sm" id="EmployeeID" name="EmployeeID" placeholder=
                                      "Employee ID" type="number" value="" required  onkeyup="javascript:capitalize(this.id, this.value);" autocomplete="off">
                                </div>
                                ...
                                <div class="col-md-8">
                                 ...
                                 <option value="none" >Select</option>
                                    <?php 
                                      ...
                                      $mydb->setQuery("SELECT * FROM `tblposition`");
                           ...
                           <div class="form-group">
                              <div class="col-md-8">
                                ...
                                <div class="col-md-8">
                                  <select class="form-control input-sm" name="EmployeeStatus" id="EmployeeStatus">
                                      <option value="none" >Select</option>
