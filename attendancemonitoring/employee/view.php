<?php  
    ...
    $res = $employee->select_employee($_GET['id']);

     
    $position = New Position();
    $resPosition = $position->single_position($res->PositionID);
...
<section id="feature" class="transparent-bg">
        <div class="container">
           <div class="center wow fadeInDown">
                 <h2 class="page-header">Employee Profile</h2>
                ...
                <div class="features">
                      <div class="col-sm-3 wow fadeInDown">
                              ...
                              <div class="panel">            
                                ...
                                <a href="" data-target="#employeemodal" data-toggle="modal" >
                                <img title="profile image" class="img-hover"    src="<?php echo web_root. 'employee/'.  $res->EmPhoto; ?>">
                                </a>
                                 </div>
                              <ul class="list-group">
                              
                             
                                   <li class="list-group-item text-right"><span class="pull-left"><strong>Full Name</strong></span> <?php echo $res->Firstname .' '.$res->Lastname; ?> </li>
                                  <li class="list-group-item text-right"><span class="pull-left"><strong>Position</strong></span> <?php echo $resPosition->PositionCode.'-'.$resPosition->Description; ?> </li>
                                  <li class="list-group-item text-right"><span class="pull-left"><strong>Employee Status</strong></span> <?php echo $res->EmployeeStatus; ?> </li>
                      ...
                      `RELIGION`, `CONTACT_NO`, `HOME_ADD`, `EMAIL`, `ACC_PASSWORD`, `employee_status`, `schedID`, `position_year` -->
                      <?php
                      $currentyear = date('Y');
                      $nextyear =  date('Y') + 1;
                      ...
                      <div class="col-md-8"><h2>Employee Information</h2></div>
                        <table class="table"> 
                        <tr>
