...
<body class="theme-blue">
    ...
    <!-- Top Bar -->
    <!-- <nav class="navbar clearHeader" style="background-color: #04AA6D;"> -->
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                    href="#">Dao District, Hospital Management System</a> </div>
    ...
    <section>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            ?>
            <!--Admin Menu -->
            <div><img src="images/province_of_capiz.png" alt="" style="height: 150px;" ></a> </div>
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 120vh);">
                    <li class="header">MAIN NAVIGATION</li>
                    <li class="active open"><a href="adminaccount.php"><i
                                class="zmdi zmdi-home"></i><span>Dashboard</span></a></li>

                                <li> <a href="attendancemonitoring/index.php" target="_blank"><i
                                class="zmdi zmdi-alarm"></i><span>Employees Attendance</span> </a>
                    ...
                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                        ...
                        <ul class="ml-menu">
                            ...
                            <!-- <li><a href="admin_emergency_room.php">Add Emergency Room</a></li> -->
