...
{
    $sql = "SELECT * FROM employees WHERE login_id='$_POST[loginid]' AND status='Active'";
...
<title>HMS - Employees Login</title>
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Hospital Management System</span>EMPLOYEE Login <span class="msg">Hello, Employee!</span></h1>
        <div class="col-md-12">

    <form method="post" action="" name="frmadminlogin" id="sign_in" onSubmit="return validateform()">
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                    <div class="form-line">
                    <input type="text" name="loginid" id="loginid" class="form-control" placeholder="Login ID" /></div>
                </div>
            
                    <div class="text-center">
                    <input type="submit" name="submit" id="submit" value="Login" class="btn btn-raised waves-effect g-bg-cyan" /></div>
                    <div class="text-center"> <a href="forgot-password.html">Forgot ID?</a></div>
                </div>
            </form>
        </div>
    </div>    
