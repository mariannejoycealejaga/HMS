...
<div class="container-fluid">
  <div class="block-header">
    ...
    <?php
          $sql ="SELECT * FROM prescription where patientid='$_SESSION[patientid]' AND prescriptiondate = CURDATE()";
          $qsql = mysqli_query($con,$sql);
  ...
  <section class="container">
    <table class="table table-bordered table-striped table-hover ">
        ...
        <a href="doctor_print_prescription_patient.php?prescriptionid=<?= $_GET[prescriptionid]; ?>" target="_blank" class="btn btn-default">Print Prescription</a> -->
      </div>    
