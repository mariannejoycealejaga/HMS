...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		$sql ="UPDATE admin SET adminname='$_POST[adminname]',loginid='$_POST[loginid]',password='$hashed_password',status='$_POST[select]' WHERE adminid='$_GET[editid]'";
	...
	{
		$hashed_password = password_hash($_POST[password], PASSWORD_DEFAULT);
		$sql ="INSERT INTO admin(adminname,loginid,password,status) values('$_POST[adminname]','$_POST[loginid]','$hashed_password','$_POST[select]')";
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<div class='alert alert-success'>
